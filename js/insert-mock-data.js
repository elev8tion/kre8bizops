 ...
 * Run this once to populate the app with realistic sample data
 */
...
(function() {
    ...
    if (localStorage.getItem('elev8tion_mock_data_inserted') === 'true') {
        console.log('✓ Mock data already exists, skipping insertion');
        return;
    }

    // Check if any data already exists
    const hasExistingData = localStorage.getItem('elev8tion_contacts') ||
                           localStorage.getItem('elev8tion_projects') ||
                           localStorage.getItem('elev8tion_tasks');

    if (hasExistingData) {
        console.log('✓ Existing data found, skipping mock data insertion');
        return;
    }
    ...
    const contacts = [
        {
            ...
            status: 'active',
            tags: ['VIP', 'High Value'],
            notes: 'Key decision maker for enterprise deals. Prefers morning meetings.',
        ...
        },
        {
            ...
            notes: 'Interested in our premium package. Schedule demo next week.',
        ...
        },
        {
            ...
            status: 'active',
            tags: ['VIP'],
            notes: 'Long-term client. Annual contract renewal in 3 months.',
        ...
        },
        {
            ...
            notes: 'Fast-growing startup. Budget approved for Q2.',
        ...
        },
        {
            ...
            status: 'active',
            tags: ['High Value'],
            notes: 'Manages multiple departments. Potential for expansion.',
    ...
    const projects = [
        ...
        },
        {
            ...
            description: 'Comprehensive digital marketing campaign across all channels',
        ...
        },
        {
            ...
            description: 'Custom CRM integration with existing tools',
    ...
    // 3. INSERT TASKS (some overdue)
    const tasks = [
        {
            id: generateId(),
            title: 'Design Homepage Mockup',
            description: 'Create initial design concepts for TechCorp homepage',
        ...
        },
        {
            ...
            description: 'Prepare presentation slides and demo for Innovate.io',
        ...
        },
        {
            ...
            description: 'Plan Q4 content calendar for all platforms',
        ...
        },
        {
            ...
            description: 'Complete technical documentation for CRM API endpoints',
        ...
        },
        {
            ...
            description: 'Deliver final brand guidelines document to client',
    ...
    const invoices = [
        ...
        },
        {
            ...
            status: 'overdue',
            items: [
                { description: 'Social Media Management - September', quantity: 1, rate: 5000, amount: 5000 },
        ...
        },
        {
            ...
            items: [
                ...
                { description: 'Brand Guidelines Document', quantity: 1, rate: 5000, amount: 5000 }
            ],
            subtotal: 25000,
            tax: 2000,
            total: 27000,
        ...
        },
        {
            ...
            items: [
                ...
                { description: 'Data Migration Services', quantity: 1, rate: 4000, amount: 4000 }
            ],
            subtotal: 10000,
            tax: 800,
            total: 10800,
    ...
    const deals = [
        {
            ...
            description: 'Annual enterprise package with premium support',
            tags: ['VIP', 'High Value'],
        ...
        },
        {
            ...
            description: 'Full mobile app development with maintenance',
        ...
        },
        {
            ...
            description: 'Annual marketing retainer agreement',
            tags: ['Marketing', 'VIP'],
            createdAt: new Date(Date.now() - 18 * 24 * 60 * 60 * 1000).toISOString(),
            updatedAt: new Date().toISOString()
        },
    ...
    // 7. INSERT ACTIVITIES (for timeline)
    const activities = [
        {
            id: generateId(),
            type: 'contact',
        ...
        },
        {
            ...
            type: 'contact',
            action: 'created',
            description: 'Created contact: Michael Chen',
            timestamp: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000).toISOString(),
            itemId: contacts[1].id
        },
        {
            id: generateId(),
            type: 'project',
            action: 'updated',
            description: 'Updated project: Mobile App Development - Innovate',
            timestamp: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
            itemId: projects[1].id
        },
        {
            id: generateId(),
            type: 'task',
        ...
        },
        {
            ...
            type: 'invoice',
            action: 'sent',
            description: 'Sent invoice INV-2025-001 to TechCorp Solutions',
        ...
        },
        {
            ...
            type: 'expense',
            action: 'created',
            description: 'Logged expense: Client Dinner - TechCorp Meeting ($287.50)',
            timestamp: new Date(Date.now() - 18 * 24 * 60 * 60 * 1000).toISOString(),
            itemId: expenses[1].id
        }
    ];

    localStorage.setItem('elev8tion_activities', JSON.stringify(activities));
    console.log('✓ Created 10 activity timeline entries');

    // 8. UPDATE SETTINGS (add business info)
    const settings = {
    ...
    // Mark that mock data has been inserted
    ...
    console.log('');
    console.log('✅ Data is now in localStorage and ready to use!');
